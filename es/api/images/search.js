...
export default async function handler(req, res) {
  ...
  try {
    // تم إضافة &lr=lang_es&hl=es لضمان نتائج صور من مصادر إسبانية
    const apiUrl = `https://www.googleapis.com/customsearch/v1?key=${randomKey}&cx=${CX}&q=${encodeURIComponent(q)}&searchType=image&num=10&start=${start}&lr=lang_es&hl=es`;
