...
export default async function handler(req, res) {
  ...
  try {
    // تم إضافة &lr=lang_en&hl=en لضمان نتائج باللغة الإنجليزية
    const apiUrl = `https://www.googleapis.com/customsearch/v1?key=${randomKey}&cx=${CX}&q=${encodeURIComponent(q)}&searchType=image&num=10&start=${start}&lr=lang_en&hl=en`;
