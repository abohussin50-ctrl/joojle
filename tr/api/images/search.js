...
export default async function handler(req, res) {
  ...
  try {
    // تم إضافة &lr=lang_tr&hl=tr لجلب نتائج صور من محتوى باللغة التركية
    const apiUrl = `https://www.googleapis.com/customsearch/v1?key=${randomKey}&cx=${CX}&q=${encodeURIComponent(q)}&searchType=image&num=10&start=${start}&lr=lang_tr&hl=tr`;
