...
export default async function handler(req, res) {
  ...
  try {
    // تم إضافة &lr=lang_de&hl=de لجلب نتائج صور من محتوى ألماني
    const apiUrl = `https://www.googleapis.com/customsearch/v1?key=${randomKey}&cx=${CX}&q=${encodeURIComponent(q)}&searchType=image&num=10&start=${start}&lr=lang_de&hl=de`;
